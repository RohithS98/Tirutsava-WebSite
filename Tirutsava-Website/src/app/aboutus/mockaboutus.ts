...
export const mockAboutUs = [
    new group( "Cultural" , [
        new Person("Person 1",'../../assets/aboutus/placeholder.png',"Cultural Sec"),
    ...
    new group( "Technical" , [
        new Person("Person 1",'../../assets/aboutus/placeholder.png',"Technical Sec"),
        new Person("Person 2",'../../assets/aboutus/placeholder.png',"Placeholder2"),
        new Person("Person 3",'../../assets/aboutus/placeholder.png',"Placeholder3"),
    ]),
    new group("Sponsorship" , [
        new Person("Person 1",'../../assets/aboutus/placeholder.png',"Something"),
        new Person("Person 2",'../../assets/aboutus/placeholder.png',"Placeholder2"),
        new Person("Person 3",'../../assets/aboutus/placeholder.png',"Placeholder3"),
