...
export const Teams = [
    new Team( 'Tirutsava Fest Heads' , [
        new Person('Pratik K Agrawalla', 'Head ', '../../assets/aboutus/Pratik.jpg', 'https://www.facebook.com/pratik.agrawalla1' , ' ' , '9439154393'),
        new Person('Sai Ritesh', 'Head', '../../assets/aboutus/placeholder.png' , ' ' , ' ' , '7702447683')
    ]),
    ...
    new Team('Hospitality Team', [
        ...
        new Person('Mahesh Vidala', 'Head', '../../assets/aboutus/Mahesh.jpg', 'https://www.facebook.com/maheshkumar.vidala', '', '8074683254'),
    ]),

    new Team('Marketing Team', [
        new Person('Pratyusha Vudutala', 'Head', '../../assets/aboutus/PV.jpg', 'https://www.facebook.com/Pratyusha.Vudutala', '', '8008987552'),
    ...
    new Team('Technical Team', [
        new Person('Vishnudev Choudhary', 'Head', '../../assets/aboutus/Vishnudev.jpg', 'https://www.facebook.com/profile.php?id=100003207622578', '', '7023232681'),
    ]),
    new Team('Finance Team', [
        new Person('Leela Krishna Mohan', 'Head', '../../assets/aboutus/Leela.jpg', 'https://www.facebook.com/sai.lkm', '', '7680872068'),
    ]),
];
